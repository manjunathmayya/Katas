...
namespace Katas
{
    ...
    {
        static List<string> LinesOfPoem;

        static House()
        {
            LinesOfPoem = new List<string>();
            LinesOfPoem.Add("the house that Jack built");
            LinesOfPoem.Add("the malt that lay in");
            LinesOfPoem.Add("the rat that ate");
            LinesOfPoem.Add("the cat that killed");
            LinesOfPoem.Add("the dog that worried");
            LinesOfPoem.Add("the cow with the crumpled horn that tossed");
            LinesOfPoem.Add("the maiden all forlorn that milked");
            LinesOfPoem.Add("the man all tattered and torn that kissed");
            LinesOfPoem.Add("the priest all shaven and shorn that married");
            LinesOfPoem.Add("the rooster that crowed in the morn that woke");
            LinesOfPoem.Add("the farmer sowing his corn that kept");
        ...
        public static string Recite(int verseNumber)
        {
            ...
            for (int count = verseNumber-1; count >= 0; count--)
            {
                verse += " " + LinesOfPoem[count];
            }
        ...
        {
            string poem = "";
            for (int count = startVerse; count <= endVerse; count++)
            {
                if (count != endVerse)
                    poem += Recite(count) + "\n";
                else
