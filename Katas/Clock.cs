...
public class Clock : IEquatable<Clock>
{
    ...
    public Clock(int hours, int minutes)
    {
        ...
        UpdateClockForMinutesAbove60();
        UpdateClockForNegativeMinutes();

        UpdateClockForHoursAbove24();
        UpdateClockForNegativeHours();
    }

    private void UpdateClockForMinutesAbove60()
    {
        while (_minutes >= 60)
        {
            _hours += 1;
    ...
    private void UpdateClockForNegativeMinutes()
    {
        while (_minutes < 0)
        {
            _hours -= 1;
    ...
    private void UpdateClockForHoursAbove24()
    {
        while (_hours >= 24)
            _hours -= 24;
    }

    private void UpdateClockForNegativeHours()
    {
        while (_hours < 0)
            _hours += 24;
    }
    ...
    {
        if (other != null)
            return other._hours == this._hours && other._minutes == this._minutes;
        else
            return false;
    }
    ...
    {
        return _hours.ToString("00")+ ":" + _minutes.ToString("00");
    }
